...
// --------------------------------------------------
export async function getMarketingAssets(): Promise<MediaAsset[]> {
...
// --------------------------------------------------
export async function getListingMedia(): Promise<MediaAsset[]> {
  const folderPath = "Tests"; // The folder you want to read
